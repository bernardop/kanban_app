...
class LaneStore {
    ...
    removeNote(noteId) {
        ...
        removeLane.notes = [...removeLane.notes.slice(0, removeNoteIndex), ...removeLane.notes.slice(removeNoteIndex + 1)];
    }
    ...
    detachFromLane({laneId, noteId}) {
        ...
        if (removeIndex !== -1) {
            lane.notes = [...notes.slice(0, removeIndex), ...notes.slice(removeIndex + 1)]
